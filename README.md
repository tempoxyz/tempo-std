...
│   ├── <a href="./src/interfaces/ICurrentCommittee.sol">ICurrentCommittee.sol</a>: TIP-1070 Current Committee (T8+) | <a href="https://github.com/tempoxyz/tempo/blob/main/tips/tip-1070.md">Docs</a> | <a href="https://github.com/tempoxyz/tempo/blob/main/crates/precompiles/src/current_committee/mod.rs">Implementation</a>
...
│   ├── <a href="./src/interfaces/IReceivePolicyGuard.sol">IReceivePolicyGuard.sol</a>: TIP-1028 Receive Policy Guard | <a href="https://github.com/tempoxyz/tempo/blob/main/tips/tip-1028.md">Docs</a> | <a href="https://github.com/tempoxyz/tempo/blob/main/crates/precompiles/src/receive_policy_guard/mod.rs">Implementation</a>
...
│   ├── <a href="./src/interfaces/IStorageCredits.sol">IStorageCredits.sol</a>: Storage credits precompile (T7+) | <a href="https://github.com/tempoxyz/tempo/blob/main/crates/precompiles/src/storage_credits/mod.rs">Implementation</a>
...
└── tx
    ...
    ├── <a href="./src/tx/KeyAuthorizationLib.sol">KeyAuthorizationLib.sol</a>: access-key authorization builder, canonical RLP encoder, and Foundry signer
    ├── <a href="./src/tx/KeyAuthorizationRlp.sol">KeyAuthorizationRlp.sol</a>: canonical signed-key-authorization wire validation (not signature recovery or chain-state validation)
